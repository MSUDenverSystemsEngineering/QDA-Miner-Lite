...
Try {
	...
	[string]$appVendor = 'Provalis Research'
	[string]$appName = 'QDA Miner Lite'
	[string]$appVersion = '2.0.7'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '01/18/2020'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'qdalite' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\SetupQMLite2.exe" -Parameters "/verysilent"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'qdalite' -CloseAppsCountdown 60
		...
		Execute-Process -Path "C:\ProgramData\Provalis Research\unins000.exe" -Parameters "/verysilent"
